...
<!--==========================
    ...
    <!--============================
        FLASH SELL START
    ==============================-->
    @include('frontend.Home.section.flash_sale')
    <!--============================
        FLASH SELL END
    ==============================-->
    ...
    <!--============================
        BRAND SLIDER START
    ==============================-->
    @include('frontend.Home.section.brand_slider')
    <!--============================
        BRAND SLIDER END
    ==============================-->
    ...
    ==============================-->
    @include('frontend.Home.section.category-based-slider-one')
    <!--============================
        ELECTRONIC PART END  
    ==============================-->
    ...
    <!--============================
        ELECTRONIC PART START  
    ==============================-->
    @include('frontend.Home.section.category-based-slider-two')
    <!--============================
        ELECTRONIC PART END  
    ==============================-->
    ...
    ==============================-->
    @include('frontend.Home.section.weekly_best')
    <!--============================
